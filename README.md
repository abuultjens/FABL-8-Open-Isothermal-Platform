...
## File download link
https://unimelbcloud-my.sharepoint.com/:f:/r/personal/buultjensa_unimelb_edu_au/Documents/FABL-8_files?csf=1&web=1&e=TzOEO4
...
### Power source
We used 19V 6.3A laptop power supply packs as power sources for the FABLE-8 units. Alternatively, a 12V power pack with at least 10A output (120W) would suffice. Using a power supply with a different wattage may cause a different heating profile and the PID parameters may need to be slightly adjusted.

### Setting up the Raspberry pi  

1. Use SDFormatter (https://www.sdcard.org/downloads/) to perform a quick format of a microSD card.  

2. Download the preconfigured image from this page https://cloudstor.aarnet.edu.au/plus/s/Bz4BOmHrPozpWsq.
  
3. Use Raspberry Pi Imager (https://www.raspberrypi.org/software/) to write 'FABL-8_img.img.gz' image to a microSD card.  
